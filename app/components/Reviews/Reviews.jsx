      ...
      <div className="container mx-auto px-4 lg:py-14">
        <div className="flex flex-wrap text-center justify-center">
          <div className="w-full lg:w-6/12 px-4">
            <h2 className="text-4xl font-semibold ">Clients Review</h2>
          </div>
        </div>
        ...
        >
          <div class="grid grid-cols-2 min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
            <div class="px-8 text-center">
              <h2 class="mb-6 block font-sans text-xl font-medium leading-[1.3] tracking-normal text-blue-gray-900 antialiased">
